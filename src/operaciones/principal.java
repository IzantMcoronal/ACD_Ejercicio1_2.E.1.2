...
public class principal {
	...
	public static void main(String[] args) {
		...
		actualizarVenta(30, 45, "12-10-2020");
		
		//Recibe una cantidad
		//numérica y se debe sumar al stock del artículo
		sumarStock(6);
		
		// Metodo para elimiar una cuenta();
		eliminarVenta(30);
	 ...
	 * @param numeventa de los productos
	 * @param nomcli de los productos
	 * @param uni de los productos
	 * @param fecha de los productos
	 */
...
/////////////////////////////////////////////////
	/**
	 * Metodo para eliominar una venta
	 * @param numeventa de la venta
	 * @return return
	 */
	private static boolean eliminarVenta(int numeventa) {
		...
		try {
			...
			if (existe == 1) {
				...
				System.out.println("Se elimino la venta: " + numeventa);
				return true;

			} else {

				System.out.println("La venta: " + numeventa+ " No existe");
				return false;
			}
...
/////////////////////////////
	/**
	 * Metodo para sumar unidades de productos a un stock
	 * @param stock de las ventas
	 * @return return
	 */
	private static boolean sumarStock(int stock) {

		System.out.println("---------------------------- ");
		System.out.println("---------SUMAR STOCK-------- ");
		System.out.println("---------------------------- ");
		try {
